														...
														<h4 class="sub-title">Cad. Usuário</h4>
														 ...
														 <form class="form-material"  action="<%= request.getContextPath() %>/ServletUsuarioController" method="post" id="formUser">
	                                                            ...
	                                                            <div class="form-group form-default form-static-label">
	                                                                <input 	type="number" name="id" id="id" class="form-control"       		readonly="readonly" value="${modelLogin.id}">
	                                                            ...
	                                                            <div class="form-group form-default form-static-label">
	                                                                <input 	type="text" name="nome" id="nome" class="form-control" 
	                                                                		placeholder="Nome" required="required" value="${modelLogin.nome}">
	                                                                <span class="form-bar"></span>
	                                                            ...
	                                                            <div class="form-group form-default form-static-label">
	                                                             ...
	                                                             <div class="form-group form-default form-static-label">
	                                                                <input 	type="text" name="login" id="login" class="form-control" 
	                                                                		required="required" autocomplete="off"  value="${modelLogin.login}">
	                                                                <span class="form-bar"></span>
